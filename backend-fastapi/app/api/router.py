...
from app.api.routes import coach, analyst, league, match, set, team, action, league_table, stat
...
router.include_router(router=stat.router, tags=["Statistics"], prefix="/stats")